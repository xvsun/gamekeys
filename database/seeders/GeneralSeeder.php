...
class GeneralSeeder extends Seeder
{
     ...
     * @return void
     */
    public function run(string $class, array $fields, array $data, bool $hasRelationships = false, bool $addTimestamps = true)
    {
        $allFields = [];
        ...
        $data = FieldArrayDiff::run($data, $existingData, $fields);
